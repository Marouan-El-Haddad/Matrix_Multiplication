...
def plot_algorithms(res: Dict[str, np.ndarray],
    ...
    algorithms = ['elementaryMultiplication', 'elementaryMultiplicationTransposed', 'tiledMultiplication', 'recursiveMultiplication']
    ...
    ax.legend(['elementaryMultiplication algorithm',
               ...
               'recursiveMultiplication algorithm'])
...
if __name__ == '__main__':
    ...
    raw_results: Dict[str, Dict[int, List[float]]] = \
        read_results('matrix_multiplication_benchmark.csv')
    ...
    #make tabular for each algorithm measured
    write_latex_tabular(refined_results['elementaryMultiplication'],
                        'matrix_elementaryMultiplication_tabular.tex')
    write_latex_tabular(refined_results['elementaryMultiplicationTransposed'],
                        'matrix_elementaryMultiplicationTransposed_tabular.tex')
    write_latex_tabular(refined_results['tiledMultiplication'],
                        'matrix_tiledMultiplication_tabular.tex')
    write_latex_tabular(refined_results['recursiveMultiplication'],
                        'matrix_recursiveMultiplication.tex')
    plot_algorithms(refined_results, 'matrix_plot.pdf')
    
    #Transpose times:
    raw_results: Dict[str, Dict[int, List[float]]] = \
        read_results('TransposeTime.csv')
    refined_results: Dict[str, np.ndarray] = dict()
    for algorithm in raw_results:
        refined_results[algorithm] = \
            compute_mean_std(raw_results[algorithm])
    ...
    #Transpose times:
    raw_results: Dict[str, Dict[int, List[float]]] = \
        read_results('TransposeRecTime.csv')
    refined_results: Dict[str, np.ndarray] = dict()
    for algorithm in raw_results:
        refined_results[algorithm] = \
            compute_mean_std(raw_results[algorithm])
    #make tabular for each algorithm measured
    write_latex_tabular(refined_results['TransposeRec'],
                        'matrix_TransposeRec_tabular.tex')
